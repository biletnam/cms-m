...
<body>
	<p>Здравствуйте, на сайте <a href="<?php echo $this->createAbsoluteUrl('/');?>">&laquo;<?php echo CHtml::encode(Yii::app()->name); ?>&raquo;</a> сделан новый заказ.</p>
    ...
    <p><b>Дата:</b> <?php echo $order->date; ?></p>
</body>
</html>
